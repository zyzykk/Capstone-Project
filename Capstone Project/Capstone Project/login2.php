...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match('/^[EM]\d{5}$/', $userId)) {
        ...
        header("Location: http://localhost/Capstone Project/login2.php");
        exit();
    }
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            if (substr($userId, 0, 1) === 'E') {
                ...
                header("Location: ApplicationList.html");
            }
            exit();
        } else {
    ...
    header("Location: http://localhost/Capstone Project/login2.html");
    exit();
}
?>
</head>
